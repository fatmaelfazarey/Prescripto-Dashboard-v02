                        ...
                        <form action="" method='post' className="was-validated" id='loginForm' onSubmit={handleSubmit}>
                            <div className="email mb-3">
                                ...
                                <input
                                    ...
                                    className='d-block border rounded p-2 w-100 bg-transparent'
                                    style={{ outline: "none", caretColor: "var(--main-color)" }}
                                ...
                                <label htmlFor="pass" className='d-block mb-2'>Password</label>
                                {
                                    togglePasswordView ?
                                        <div className='password border rounded p-2 w-100 bg-transparent position-relative'>
                                            <input type="password" name='password' id='pass' className='bg-transparent' style={{ outline: "none", border: "none", caretColor: "var(--main-color)" }} defaultValue='123' />
                                        ...
                                        <div className='text border rounded p-2 w-100 bg-transparent position-relative '>
                                            <input type="text" name='password' id='pass' className='bg-transparent' style={{ outline: "none", border: "none", caretColor: "var(--main-color)" }} defaultValue='123' />
